...
import com.domi.support.identification.ScalarConstants;
...
public class NumberUtil {
    ...
    public static String formatNumberToStringLeft4(float number){
...
//		System.out.println(formatNumber(200.5057F));
//    	System.out.println(isDigits("22"));
    	System.out.println(formatNumberToString(0f));
	}
}
