...
public class SplitAddress {  
    public static void main(String[] args){  
        try {  
            IPSeeker ipseeker = new IPSeeker(new File("C:/Users/Administrator/Desktop/qqwry.dat"));  
            IPEntity ipentity = new IPEntity();  
            String ipaddress = "210.136.134.157";  
    ...
    public static String getAddresInfo(String ipaddress) throws Exception{
//        IPSeeker ipseeker = new IPSeeker(new File("C:/Users/Administrator/Desktop/qqwry.dat"));  
      IPSeeker ipseeker = new IPSeeker(new File("/usr/local/project/amer/Amer/qqwry.dat"));  
        return ipseeker.getAddress(ipaddress);
    }    
    
	@Test
	public void testName() throws Exception {
		System.out.println(getAddresInfo("210.136.134.157"));
	}    
